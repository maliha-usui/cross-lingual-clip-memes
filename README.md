...
This work demonstrates the challenges vision-language models face when applied to Japanese content—a critical consideration for Japanese entertainment.
